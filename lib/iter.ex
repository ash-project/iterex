defmodule Iter do
  ...
  > #### Warning {: .warning}
  > This function uses two processes in order to provide a wrapper around
  > `Enumerable` that will block reduction of the enumerable until the iterable
  > is consumed.  We recommend you primarily use it for converting streams or
  > other enumerables for which a more efficient method is not present.
  """
